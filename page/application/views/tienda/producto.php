					...
					<div class="about-product row">
						<div class="details-thumb col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<div class="owl-carousel nav-style3 has-thumbs" data-autoplay="false" data-nav="true" data-dots="false" data-loop="true" data-slidespeed="800" data-margin="0"  data-responsive = '{"0":{"items":1}, "480":{"items":2}, "768":{"items":1}, "1024":{"items":1}, "1200":{"items":1}}'>
								<div class="details-item"><img src="<?php echo base_url();?>tools/images/detail1.jpg" alt=""></div>
								<div class="details-item"><img src="<?php echo base_url();?>tools/images/detail1.jpg" alt=""></div>
								<div class="details-item"><img src="<?php echo base_url();?>tools/images/detail1.jpg" alt=""></div>
								<div class="details-item"><img src="<?php echo base_url();?>tools/images/detail1.jpg" alt=""></div>
								<div class="details-item"><img src="<?php echo base_url();?>tools/images/detail1.jpg" alt=""></div>
				...
				<div class="col-xs-12 col-sm-5 col-md-4 col-lg-3 sidebar">
					...
					<div class="widget widget-banner row-banner">
						<div class="banner banner-effect1">
							<a href="#"><img src="<?php echo base_url();?>tools/images/banner23.jpg" alt=""></a>
						</div>
					</div>
					<div class="widget widget-recent-post">
						...
						<ul class="list-recent-posts">
							<li class="product-item">
								<div class="thumb"><a href="detail.html"><img src="<?php echo base_url();?>tools/images/small-product14.jpg" alt=""></a></div>
								<div class="info">
									<div class="rating">
										<ul class="list-star">
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i></a></li>
							...
							<li class="product-item">
								<div class="thumb"><a href="detail.html"><img src="<?php echo base_url();?>tools/images/small-product15.jpg" alt=""></a></div>
								<div class="info">
									<div class="rating">
										<ul class="list-star">
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i></a></li>
							...
							<li class="product-item">
								<div class="thumb"><a href="detail.html"><img src="<?php echo base_url();?>tools/images/small-product16.jpg" alt=""></a></div>
								<div class="info">
					...
					<div class="owl-carousel product-list-owl nav-style2 equal-container" data-autoplay="false" data-nav="true" data-dots="false" data-loop="false" data-slidespeed="800" data-margin="0"  data-responsive = '{"0":{"items":1}, "480":{"items":2}, "650":{"items":3}, "1024":{"items":4}, "1200":{"items":5}}'>
						...
						<div class="product-item layout1">
							<div class="product-inner equal-elem">
								...
								<div class="thumb">
									<a href="#" class="quickview-button"><span class="icon"><i class="fa fa-eye" aria-hidden="true"></i></span> Quick View</a>
									<a href="detail.html" class="thumb-link"><img src="<?php echo base_url();?>tools/images/product7.jpg" alt=""></a>
								</div>
								<div class="info">
						...
						<div class="product-item layout1">
							<div class="product-inner equal-elem">
								...
								<div class="thumb">
									<a href="#" class="quickview-button"><span class="icon"><i class="fa fa-eye" aria-hidden="true"></i></span> Quick View</a>
									<a href="detail.html" class="thumb-link"><img src="<?php echo base_url();?>tools/images/product24.jpg" alt=""></a>
								</div>
								<div class="info">
									<a href="detail.html" class="product-name">Fujifilm INSTAX Mini 8 Instant Camera (White)</a>
									<div class="price">
